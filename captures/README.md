...
`docs/18_future_work.md` Priority 1 and Priority 3, both of which identify
...
(not raw USB bus traffic) — see `research/captures/README.md`.

When a capture is added here, reference it from the relevant document
(`docs/10_protocol_analysis.md` for protocol-level captures,
`docs/16_charging_led_research.md` for a charging-transition-correlated
