...
bypass, see [`02_background.md`](02_background.md)).

**This repository does not include these files.** Valve's firmware remains
Valve's property; see the Legal Notice in the top-level [`README.md`](../README.md). Obtain
...
SHA-256 hashes in [`hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt).
...
4. Verify your files match this documentation:
   ...
   sha256sum *.fw
   ```
   Compare the output against [`hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt). If your SteamVR
   ...
   file-offset findings in [`05_firmware_layout.md`](05_firmware_layout.md) and [`06_firmware_symbols.md`](06_firmware_symbols.md)
   (which were derived from one specific build) may need to be re-derived
   for your build. The overall container format ([`05_firmware_layout.md`](05_firmware_layout.md))
...
engineering in [`05_firmware_layout.md`](05_firmware_layout.md) (i.e., that work is not
overfit to a single file). See [`hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt) for the complete,
...
command — see [`docs/03_hardware.md`](03_hardware.md)).
...
[`05_firmware_layout.md`](05_firmware_layout.md).
...
analyzed further in this project; see [`18_future_work.md`](18_future_work.md).
...
[`05_firmware_layout.md`](05_firmware_layout.md)). This was independently confirmed for all five
...
layout ([`05_firmware_layout.md`](05_firmware_layout.md)).
...
- [ ] Located the `drivers/indexcontroller/resources/firmware/indexcontroller/`
      directory.
- [ ] Verified file hashes against [`hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt), or noted
...
If any step fails, see [`docs/14_failed_attempts.md`](14_failed_attempts.md) for known issues, or
[`docs/17_safety.md`](17_safety.md) for general troubleshooting guidance before proceeding
further.
