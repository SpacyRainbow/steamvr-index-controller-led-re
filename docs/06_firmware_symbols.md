...
application firmware based at `0x412000` (see [`05_firmware_layout.md`](05_firmware_layout.md) §5.4
...
[`05_firmware_layout.md`](05_firmware_layout.md)), was used to empirically confirm `0x412000` as the
...
The live debug shell's `config` command ([`docs/11_hid_commands.md`](11_hid_commands.md)) prints
...
[`scripts/decode_config_table.py`](../scripts/decode_config_table.py) for the exact decoder and
[`research/firmware_analysis/config_table_decode_output.txt`](../research/firmware_analysis/config_table_decode_output.txt) for the full
verification output.
...
These are the exact byte locations patched in [`docs/15_firmware_patching.md`](15_firmware_patching.md)
Experiment 6. Note (see [`docs/16_charging_led_research.md`](16_charging_led_research.md)): these values
...
preserved in [`research/firmware_analysis/config_table_decode_output.txt`](../research/firmware_analysis/config_table_decode_output.txt).

## 6.3 LED color pipeline functions (100% confidence for structure, live-verified for behavior)

Full narrative and call-graph description in [`docs/07_led_architecture.md`](07_led_architecture.md).
...
[`docs/14_failed_attempts.md`](14_failed_attempts.md), as a concrete example of how manual
...
Full list preserved in [`research/firmware_analysis/strings_led_all.txt`](../research/firmware_analysis/strings_led_all.txt).
Highlights:
...
Found during the [`docs/16_charging_led_research.md`](16_charging_led_research.md) follow-up session by
identifying the literal-pool operand loaded by every known
power-management function ([`docs/16_charging_led_research.md`](16_charging_led_research.md) "The
