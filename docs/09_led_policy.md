...
device state — as distinct from the *mechanism* ([`docs/07_led_architecture.md`](07_led_architecture.md))
...
decision code itself, see [`docs/16_charging_led_research.md`](16_charging_led_research.md).
...
repository; see the correction note in [`docs/14_failed_attempts.md`](14_failed_attempts.md).
...
| Charging (connected to USB, battery below full) | Orange | Inferred from firmware log strings (`" PM -> charging\n"`, `"charge term"` etc. — see [`docs/16_charging_led_research.md`](16_charging_led_research.md)) and general Index Controller knowledge; **not independently visually confirmed during this project's live testing** | 50% (consistent with general knowledge, not independently re-verified live in this project) |
...
| Forced black (patched firmware) | Off | Directly observed by the human tester after applying the Layer-1 code patch ([`docs/15_firmware_patching.md`](15_firmware_patching.md)) | 100% (directly observed) |
...
## Implication for the connection-state hypothesis (new, see [`docs/16_charging_led_research.md`](16_charging_led_research.md))
...
([`docs/16_charging_led_research.md`](16_charging_led_research.md)): it means the firmware almost
...
**charging-state** concept ([`docs/06_firmware_symbols.md`](06_firmware_symbols.md) §6.5's `+0xc`
...
multi-way charging state machine. See [`docs/16_charging_led_research.md`](16_charging_led_research.md)
...
found via a full string search ([`docs/16_charging_led_research.md`](16_charging_led_research.md) documents
the search):
...
disassembly excerpt in [`docs/16_charging_led_research.md`](16_charging_led_research.md)). Whether this
...
in [`docs/08_lp5562_driver.md`](08_lp5562_driver.md)), and is presumed to be a factory/production
...
(§ [`docs/15_firmware_patching.md`](15_firmware_patching.md) Experiment 6/`indexcontroller_app_LEDTEST_v0.fw`).
...
that reference a "glow pattern ID" field ([`docs/06_firmware_symbols.md`](06_firmware_symbols.md)
