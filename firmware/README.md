...
[`README.md`](../README.md) "Legal notice" section.

To obtain the exact firmware files referenced throughout this
documentation, see [`docs/04_firmware_acquisition.md`](../docs/04_firmware_acquisition.md). Verify what you
obtain against [`hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt).
...
[`hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt) before flashing it — this confirms your build
