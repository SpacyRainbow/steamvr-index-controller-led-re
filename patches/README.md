...
complete firmware images — see the top-level [`README.md`](../README.md) legal notice and
...
hash in [`../hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt)) — i.e., it must be applied
...
→ rebuild footer → flash), see [`../docs/15_firmware_patching.md`](../docs/15_firmware_patching.md). The
...
**File:** [`patch_A_led_current_255.decompressed.xdelta3`](patch_A_led_current_255.decompressed.xdelta3),
[`patch_A_led_current_0.decompressed.xdelta3`](patch_A_led_current_0.decompressed.xdelta3)
...
([`../docs/11_hid_commands.md`](../docs/11_hid_commands.md)) exposes four `led_driver_current_{r,g,b,w}`
values, default `8`, identified via the config-table structure recovery
in [`../docs/06_firmware_symbols.md`](../docs/06_firmware_symbols.md) §6.2. These are the most directly
...
[`../docs/13_experiments.md`](../docs/13_experiments.md) Experiment 6b). value=0 produced a dramatic,
...
[`../docs/15_firmware_patching.md`](../docs/15_firmware_patching.md) §15.5).

**Compatibility:** validated only against
`indexcontroller_app_20230902_v1693638519.fw` (hash in
[`../hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt)). The config table's exact offsets are
expected to shift on any firmware build compiled differently — see
[`../docs/17_safety.md`](../docs/17_safety.md).
...
**File:** [`patch_B_led_black.decompressed.xdelta3`](patch_B_led_black.decompressed.xdelta3)
**Generator script:** [`../scripts/patch_led_black.py`](../scripts/patch_led_black.py)
...
color rather than the sole determinant of output ([`../docs/08_lp5562_driver.md`](../docs/08_lp5562_driver.md)).
Static analysis ([`../docs/06_firmware_symbols.md`](../docs/06_firmware_symbols.md) §6.3,
[`../docs/07_led_architecture.md`](../docs/07_led_architecture.md) Layer 1) identified the exact instruction
...
[`../docs/13_experiments.md`](../docs/13_experiments.md) Experiment 7 for the full evidence chain.
...
see [`../docs/16_charging_led_research.md`](../docs/16_charging_led_research.md) for the (currently unresolved)
work to make this selective.

**Rollback procedure:** flash the original, unmodified firmware (see
[`../docs/15_firmware_patching.md`](../docs/15_firmware_patching.md) §15.5). No special unpatch procedure is
needed — this single-instruction change has no persistent side effects
outside the flashed firmware image itself.

**Compatibility:** validated only against
`indexcontroller_app_20230902_v1693638519.fw` (hash in
[`../hashes/firmware_hashes.txt`](../hashes/firmware_hashes.txt)). The exact file offset is specific to this
build's compiled code layout — see [`../docs/17_safety.md`](../docs/17_safety.md).
...
**File:** [`patch_C_led_blue_255.decompressed.xdelta3`](patch_C_led_blue_255.decompressed.xdelta3)
**Generator script:** [`../scripts/patch_led_solid_color.py`](../scripts/patch_led_solid_color.py)
...
[`../docs/18_future_work.md`](../docs/18_future_work.md) Priority 1 for the recommendation to flash and
verify it as the first task in the next session with hardware access, and
[`../docs/13_experiments.md`](../docs/13_experiments.md), which intentionally does **not** yet contain
...
white, [`../docs/09_led_policy.md`](../docs/09_led_policy.md)) don't produce.
...
design choice — see [`../docs/15_firmware_patching.md`](../docs/15_firmware_patching.md) §15.3 for why a
...
modification ([`../docs/17_safety.md`](../docs/17_safety.md)) — don't assume it's as
